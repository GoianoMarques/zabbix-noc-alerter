...
const I18N = {
  pt: {
    ...
    ign_sup: 'Ignorar problemas suprimidos', ign_ack: 'Ignorar problemas já reconhecidos (ack)',
  ...
  en: {
    ...
    ign_sup: 'Ignore suppressed problems', ign_ack: 'Ignore already acknowledged problems',
  ...
  es: {
    ...
    ign_sup: 'Ignorar problemas suprimidos', ign_ack: 'Ignorar problemas ya reconocidos (ack)',
